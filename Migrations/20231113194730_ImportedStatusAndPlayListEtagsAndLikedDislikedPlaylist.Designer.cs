...
namespace MediaTrackerYoutubeService.Migrations
{
    ...
    [Migration("20231113194730_ImportedStatusAndPlayListEtagsAndLikedDislikedPlaylist")]
    partial class ImportedStatusAndPlayListEtagsAndLikedDislikedPlaylist
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MediaTrackerYoutubeService.Models.User", b =>
                {
                    ...
                    b.Property<string>("DisikedVideosEtag")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
