...
namespace MediaTrackerYoutubeService.Tests.Services
{
    ...
    public class AuthTokenExchangeServiceTests
    {
        ...
        public async Task YoutubeAuthTokenExchange_ValidResponse_ReturnsAccessToken()
        {
            // Arrange
            int userId = 8;
            string expectedAccessToken = "ya29.a0AfB_byBNHgwUi_NawZ078bv-tvdpZ-4Oaftv8wKnyCcxScQesnxIepMTkml0tJzQbixPzTDxNzSQMuWt4JvidvN0SBK2OnlICEYMHnauE0UyXmKN5Q4LOb_Rzm-wMlSLGl24DmXSuUN7xVfmLdvtbiZB0W2KS0qBYnISaCgYKAdMSARASFQGOcNnCE7VZIho8k8k2BlCAVL-Yjw0171";
